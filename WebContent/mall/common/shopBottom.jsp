...
.b_line { margin: 20px 0; border:1px solid #e9ecef; clear: both;}
/*b_box1*/
...
<div class="bottom">
	<div class="b_box1">
		<span class="b1_s1 bb1">EZENMALL 소개</span> |
	...
	<div class="b_box2">
		<div class="b2_s1">
			<div class="c_b2">이젠몰글로벌 유한회사</div>
			<div class="c_b2">서울특별시 강남구 서초구 서초대로77길 54 서초더블유타워 13,14층</div>
			<div class="c_b2">사업자등록번호 : 111-11-1111 | 통신판매업신고 : 강남 11111호 <span>사업자정보확인></span></div>
			<div class="c_b2">업무집행자: 김송이</div>
		</div>
		<div class="b2_s2">
			<div class="c_b2">고객센터 ></div>
			<div class="c_b2">경기도 일산시 일산대로 111 11층</div>
			<div class="c_b2">Tel : <span>02-1111-1111</span> (평일 09:00 ~ 18:00) | 이젠클럽 전용 : <span>070-2564-5478(365일 09:00 ~ 18:00)</span></div>
			<div class="c_b2">Fax : 02-532-6850 | Mall : ezen@ezenmall.co.kr</div>
		</div>
	</div>
	<hr class="b_line">
	<div class="b_box3">
		<div class="bb3">전자금융분쟁처리 > Tel : 1566-5701 | Fax : 02-589-8844 | Mail : gmk_cs@ezenmall.co.kr &emsp;&emsp;&emsp;분쟁처리절차 ></div>
	...
	<hr class="b_line">
	<div class="b_box4">
		<div><img src="../../icons/logo_kolsa.png" height="15">&emsp;한국온라인쇼핑협회 수상·인증 내역 </div>
	</div>
</div>
